...
if ( ! function_exists( 'foodie_diary_section_top_header_content' ) ) :
    ...
    function foodie_diary_section_top_header_content() {
        ...
        $foodie_diary_top_header_phone = get_theme_mod( 'foodie_diary_top_header_phone', ' (004) 423-5909' );
        $foodie_diary_top_header_email = get_theme_mod( 'foodie_diary_top_header_email', 'Ouattara-hamed@hotmail.com' );
?>
